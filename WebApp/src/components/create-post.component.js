...
const CreatePost = (props) => {
  ...
  return (
    <form
      className="col-md-8 pt-4 border border-secondary border-2 rounded mx-auto bg-light"
      onSubmit={submitHandler}
    >
      <div className="row col-11 mx-auto">
        <textarea
          className="col-12 form-control bg-white text-wrap text-break"
          name="message"
          rows="5"
          placeholder="Type..."
          value={message}
      ...
      <br />
      <div className="col-11 mx-auto d-flex justify-content-evenly bg-light p-2 rounded">
